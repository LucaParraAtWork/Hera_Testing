...
TEST_CASES = [
    {
        "id":     "Nom_WN_01/08",
        "file":   "Virya_Nomination_Week20.csv",
        "expect": "PASS",
        "desc":   "Happy path – Virya Week 20 (first import, baseline check)",
    },
    {
        "id":     "Nom_WN_03",
        "file":   "Messer_Nomination_Week20.csv",
        "expect": "PASS",
        "desc":   "Happy path – Messer Week 20",
    },
    {
        "id":     "Nom_WN_04",
        "file":   "Virya_Nomination_Week20_V2.csv",
        "expect": "PASS",
    ...
    {
        "id":     "NEG_05",
        "file":   "Virya_Nomination_Week20_NEG05_WrongParitySlot.csv",
        "expect": "FAIL",
        "desc":   "Type 1 on even slot 2 – belongs to Messer, not Virya",
    },
    {
        "id":     "NEG_06",
        "file":   "Virya_Nomination_Week20_NEG06_InvalidTrailerType.csv",
        "expect": "FAIL",
        "desc":   "Invalid trailer type 'Type 99' on slot 3 Drop-Off",
    },
    {
        "id":     "NEG_07",
        "file":   "Virya_Nomination_Week20_NEG07_WrongHeaders.csv",
        "expect": "FAIL",
        "desc":   "Wrong CSV header: 'SlotID' instead of 'PickUpSlotID'",
    },
    {
        "id":     "NEG_08",
        "file":   "Virya_Nomination_Week20_NEG08_MaintWithTrailer.csv",
        "expect": "FAIL",
        "desc":   "Trailer assigned to a Maint. row (power-constrained slot)",
    },
    {
        "id":     "NEG_10",
        "file":   "Virya_Nomination_Week20_NEG10_OverlappingSlots.csv",
        "expect": "FAIL",
        "desc":   "Slot 3 end time overlaps slot 5 start time",
    },
    {
        "id":     "NEG_13",
        "file":   "Virya_Nomination_Week20_NEG13_WrongDateFormat.csv",
        "expect": "FAIL",
        "desc":   "Date format mm/dd/yyyy instead of dd/mm/yyyy",
    },
    {
        "id":     "NEG_15",
        "file":   "Virya_Nomination_Week20_NEG15_TwoDropOff.csv",
        "expect": "FAIL",
        "desc":   "Two consecutive Drop-Offs – plant already occupied at slot 3",
    },
    {
        "id":     "NEG_16",
        "file":   "Virya_Nomination_Week20_NEG16_EditedValues.csv",
        "expect": "?",
        "desc":   "Manually edited values still within valid range – observe behaviour",
    },
    {
        "id":     "NEG_17",
        "file":   "Virya_Nomination_Week20_NEG17_PickUpEmptyPlant.csv",
        "expect": "FAIL",
        "desc":   "Pick-Up on slot 1 with empty plant (no prior Drop-Off)",
    },
    {
        "id":     "NEG_18",
        "file":   "Virya_Nomination_Week20_NEG18_WrongPickUpType.csv",
        "expect": "FAIL",
